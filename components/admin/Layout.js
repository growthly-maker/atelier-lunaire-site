...
export default function AdminLayout({ children }) {
  ...
  if (!session || !session.user.isAdmin) {
    console.log("Redirection: l'utilisateur n'est pas admin ou n'est pas connecté");
    // Dans un environnement client, nous redirigeons
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="lg:hidden">
        <div className="fixed inset-0 flex z-40">
          ...
          <div 
            className={`
              fixed inset-y-0 left-0 flex flex-col w-64 bg-primary-800 text-white transform transition-transform duration-300 ease-in-out
